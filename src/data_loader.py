...
warnings.simplefilter(
    "ignore", NoAuthWarning
)  # ignores NoAuthWarning as I"m using the free version
...
def get_wsl_data(filename="WSL_2023-2024.parquet"):
    ...
    data_path = base_directory / "data" / "WSL_2023-2024.parquet"
    ...
    final_df = sb.competition_events(
        country="England",
